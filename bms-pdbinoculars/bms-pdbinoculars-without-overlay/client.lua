...
local toggle_vision = 10 -- control id to toggle vision mode. Default: INPUT_AIM (PgUP)
...
RegisterNetEvent('bms-binoculars:Active') --Just added the event to activate the binoculars
AddEventHandler('bms-binoculars:Active', function()
	helicam = not helicam
end)
...
function GetVehicleInView(cam)
	...
	local rayhandle = CastRayPointToPoint(coords, coords+(forward_vector*200.0), 10, GetVehiclePedIsIn(GetPlayerPed()), 0)
